...
// Kalo udah masuk, langsung ke katalog aja
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($hasil['status']) {
            ...
            $_SESSION['user_id'] = $hasil['data']['id_user'];
            $_SESSION['user_nama'] = $hasil['data']['nama'];
            $_SESSION['user_username'] = $hasil['data']['username'];
...
<head>
    <meta charset="utf-8">
    <title>Sistem Peminjaman - Login User</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="">
                            ...
                            <p class="text-center mb-0">Belum punya akun? <a href="userregist.php">Daftar di sini</a></p>
