...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama) || empty($username) || empty($password)) {
        ...
        // Daftarin sekarang
        $hasil = registerAdmin($nama, $username, $password);
        $pesan = $hasil['pesan'];
...
<head>
    <meta charset="utf-8">
    <title>Sistem Peminjaman - Register Admin</title>
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.php" class="">
                                <h3 class="text-primary"><img src="bootstrap/img/Gemini_Image_acwmhaacwmhaacwm-removebg-preview.png" alt="Logo SIMBA" style="height: 60px;"></h3>
                            </a>
                            <h3>Sign Up</h3>
                        </div>
                        ...
                        <form method="POST" action="">
                            ...
                            <p class="text-center mb-0">Sudah punya akun? <a href="adminlogin.php">Login di sini</a></p>
                        </form>
                    </div>
                </div>
            </div>
